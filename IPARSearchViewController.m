...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.row == 0) {
        self.searchButton.frame = CGRectMake(0, 0, [[UIScreen mainScreen] bounds].size.width, cell.frame.size.height);
        [cell.contentView addSubview:self.searchButton];
        // set the center constraint
        return cell;
    }
